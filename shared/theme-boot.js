...
(function () {
  ...
  window.OE_THEMES = {
    ...
    'glaceir': {
      ...
      dark: true,
      vars: {
        '--md-sys-color-background': '#001020',
        '--md-sys-color-background-rgb': '0, 16, 32',
        '--md-sys-color-surface': '#061826',
        '--md-sys-color-surface-variant': '#12283c',
        '--md-sys-color-primary': '#a8e6ff',
        '--md-sys-color-on-primary': '#00323f',
        '--md-sys-color-secondary-container': '#1c3c52',
        '--md-sys-color-on-secondary-container': '#cceeff',
        '--md-sys-color-on-surface': '#dcf0fa',
        '--md-sys-color-on-surface-variant': '#a0bcc9',
        '--md-sys-color-outline': '#35566b',
        '--md-sys-color-outline-rgb': '53, 86, 107',
        '--md-sys-color-outline-variant': '#6992a8',
        '--md-sys-color-error': '#ffb4ab',
        '--md-sys-color-success': '#a6d9a8',
        '--md-sys-state-hover': 'rgba(255,255,255,0.07)',
        '--md-sys-color-hover-surface': '#0d2233',
      },
    },
    'sage': {
      name: 'Sage',
